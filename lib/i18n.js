const STRINGS = {
  zh: {
    ...
    keyNext: "下一页",
    keyRestore: "还原原文",
    shortcutHint: "当前键以本页表格和弹窗为准。若没反应，到 chrome://extensions/shortcuts 改掉被占用的键。Mac 请用 Ctrl，不是 Command。",
    editShortcuts: "修改快捷键",
    importTitle: "导入",
    chooseFile: "选择文本文件",
    encoding: "编码",
    ...
    support: "支持",
    donateTitle: "支持作者",
    donateLead: "功能全部免费。如果觉得有用，可以请我喝杯咖啡。",
    donateWechat: "微信",
    donateAlipay: "支付宝",
    donateKofi: "在 Ko-fi 请我喝杯咖啡",
    chapterJump: "跳转章节",
  ...
  en: {
    extName: "Stealth Novel",
    popupTitle: "Stealth Novel",
    optionsTitle: "Stealth Novel · Settings",
    ...
    shortcutHint: "The table and popup show the keys Chrome actually bound. If a key does nothing, change it at chrome://extensions/shortcuts. On a Mac, use Control, not Command.",
    editShortcuts: "Change shortcuts",
    importTitle: "Import",
    ...
    donateLead: "Everything is free. If you find it useful, you can buy me a coffee.",
    donateWechat: "WeChat",
    donateAlipay: "Alipay",
